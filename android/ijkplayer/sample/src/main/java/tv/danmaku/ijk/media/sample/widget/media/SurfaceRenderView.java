...
public class SurfaceRenderView extends SurfaceView implements IRenderView {
    ...
    private static final class SurfaceViewHolder implements IRenderView.ISurfaceHolder {
        private SurfaceRenderView mSurfaceView;
        private SurfaceHolder mSurfaceHolder;

        public SurfaceViewHolder(@NonNull SurfaceRenderView surfaceView,
    ...
    private static final class SurfaceCallback implements SurfaceHolder.Callback {
        ...
        public void addRenderCallback(@NonNull IRenderCallback callback) {
            ...
            if (mSurfaceHolder != null) {
                if (surfaceHolder == null)
                    surfaceHolder = new SurfaceViewHolder(mWeakSurfaceView.get(), mSurfaceHolder);
            ...
            if (mIsFormatChanged) {
                if (surfaceHolder == null)
                    surfaceHolder = new SurfaceViewHolder(mWeakSurfaceView.get(), mSurfaceHolder);
                callback.onSurfaceChanged(surfaceHolder, mFormat, 0, 0);
            }
        }
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            ...
            ISurfaceHolder surfaceHolder = new SurfaceViewHolder(mWeakSurfaceView.get(), mSurfaceHolder);
