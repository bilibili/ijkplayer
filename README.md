...
dependencies {
    ...
    # Other ABIs: optional
    compile 'tv.danmaku.ijk.media:ijkplayer-armv5:0.4.5'
    compile 'tv.danmaku.ijk.media:ijkplayer-arm64:0.4.5'
    compile 'tv.danmaku.ijk.media:ijkplayer-x86:0.4.5'

    # ExoPlayer as IMediaPlayer: optional, experimental
    compile 'tv.danmaku.ijk.media:ijkplayer-exo:0.4.5'
}
```
- iOS
 - in coming...
