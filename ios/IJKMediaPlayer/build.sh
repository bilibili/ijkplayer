rm -rf build
xcrun xcodebuild -scheme IJKMediaFrameworkWithSSL -target IJKMediaFrameworkWithSSL -configuration Debug -sdk iphonesimulator -destination "platform=iOS Simulator,name=iPhone 5s" build -derivedDataPath build && \
