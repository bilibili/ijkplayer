...
IJK_FFMPEG_UPSTREAM=https://github.com/lw0717/FFmpeg.git
IJK_FFMPEG_FORK=https://github.com/lw0717/FFmpeg.git
IJK_FFMPEG_COMMIT=ff4.0--ijk0.8.25--20200930--001
