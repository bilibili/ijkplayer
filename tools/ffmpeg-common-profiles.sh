...
# export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --disable-parser=aac_latm"
...
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --disable-parser=hevc"
...
# export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --disable-parser=mpegaudio"
